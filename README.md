...
`-ifp`               | Index is a floating point decimal value. This sets the precision. If it is less than the number of digits left to the decimal point then the indexes might be rendered in scientific format.
`-ns`                | Name string.
